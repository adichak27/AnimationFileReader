...
public class AnimationFileReader {
   ...
   */
  public Animator readFile(String fileName, TweenModelBuilder<Animator> builder) throws
    ...
    while (sc.hasNext()) {
      ...
      switch (command) {
        ...
        case "oval":
          ...
          break;
        case "plus":
          RectangleInfo plusInfo = readRectangleInfo(sc);
          builder.addPlus(plusInfo.getName(),
                  plusInfo.getX(), plusInfo.getY(),
                  plusInfo.getWidth(), plusInfo.getHeight(),
                  plusInfo.getR(), plusInfo.getG(), plusInfo.getB(),
                  plusInfo.getStart(), plusInfo.getEnd());
          break;
        case "move":
